...
var images =
  []; /* Two images that are alternated in ordered to get the blinking effect of the 
                       spectrophotometer. */
...
function initial_function() {
  ...
  document.getElementById("demo").innerHTML =
    "Step-No 1: The solutions to be analyzed are selcted from the drop-down menu. The solution concentrations are selected from the concentration scale bars & turn on the instrument clicking on the power button and wait for 30 mins for initialization of the instrument.";
...
function removeClock() {
  ...
  document.getElementById("demo").innerHTML =
    "Step-No 2: Click on the beaker to take a clean, dry beaker.";
...
function scanGraph() {
  if (step_no == 12) {
    ...
    // Hide all scan images.
    $(".scanimage").css("visibility", "hidden");

    // make the video obtained visible.
    vid.style.visibility = "visible";
    vid.style.display = "block"; // Ensure the video is displayed
